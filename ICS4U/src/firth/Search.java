...
public class Search {
	...
	/**
	 * This method searches through an array linearly and returns the index of
	 * the desired element if found or -1 if not
	 * 
	 * @param a
	...
	/**
	 * This method searches through an integer array using recursion and returns
	 * the index of the desired element if found or -1 if not
	 * 
	 * @param a
	 *            the integer array that is searched
	 * @param start
	...
	/**
	 * This method searches through a double array using recursion and returns
	 * the index of the desired element if found or -1 if not
	 * 
	 * @param a
	 *            the double array that is searched
	...
	/**
	 * This method searches through a String array using recursion and returns
	 * the index of the desired element if found or -1 if not
	 * 
	 * @param a
	 *            the String array that is searched
